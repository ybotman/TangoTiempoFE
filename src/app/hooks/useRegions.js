    ...
    useEffect(() => {
        ...
        const getRegions = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_TangoTiempoBE_URL}/api/regions` || 'https://tangotiempobe-g3c0ebh2b6asbbd6.eastus-01.azurewebsites.net/api/regions');
