    ...
    >
      <Box sx={modalStyle}>
        ...
        <Typography id="event-details-modal-description" sx={textStyle}>
          ...
          <br />
          <strong style={{ color: 'black' }}>Cost:</strong>{' '}
          {event.extendedProps.cost}
          <br />
          <strong style={{ color: 'black' }}>Region:</strong>{' '}
          {event.extendedProps.calculatedRegionName}
          <br />
          <strong style={{ color: 'black' }}>Division:</strong>{' '}
          {event.extendedProps.calculatedDivisionName}
          <br />
          <strong style={{ color: 'black' }}>City:</strong>{' '}
          {event.extendedProps.calculatedCityName}
          <br />
          <strong style={{ color: 'black' }}>Recurrence:</strong>{' '}
          {event.extendedProps.recurrenceRule}
          <br />
          <strong style={{ color: 'black' }}>Categories:</strong>{' '}
          {`${event.extendedProps.categoryFirst || ''}, ${event.extendedProps.categorySecond || ''}, ${event.extendedProps.categoryThird || ''}`.replace(
            /, ,/g,
            ''
          )}
        </Typography>
