...
module.exports = {
  ...
  openGraph: {
    ...
    description: 'The United States\' first fully dedicated Argentine Tango calendar. Open, easy, and free to use. Every feature for searching, finding, adding, and managing Tango events is free, forever.',
    images: [
      {
        url: 'http://tangotiempo.com/images/TangoTiempo2.jpg', // Update with the actual path to your Open Graph image
        width: 1555,
        height: 530,
        alt: 'Tango Tiempo - Argentine Tango Calendar',
      },
    ],
    site_name: 'Tango Tiempo',
  },
